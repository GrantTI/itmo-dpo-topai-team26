...
| Балл | Критерий |
|------|----------|
| 20-25 | Все этапы выполнены полностью, код соответствует архитектуре, все эндпоинты работают корректно |
| 15-19 | Выполнены этапы 1-4, есть небольшие недочеты в работе этапа 5 |
| 10-14 | Выполнены этапы 1-3, есть базовая работа с данными и обучением |
| 5-9 | Выполнены этапы 1-2, реализована загрузка и предпросмотр данных |
| 0-4 | Работа не выполнена или не запускается |
