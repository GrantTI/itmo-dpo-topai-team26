...
| 2 | Frontend | LC-5 | LC-5.1 | С | Способен применять инструменты промышленной разработки фронтенда; Умеет реализовывать интерфейсы для работы с данными | Текущая | [Модуль M2-Frontend](https://github.com/GrantTI/itmo-dpo-topai-team26/blob/main/M2-Frontend/README.md) | ссылка |
