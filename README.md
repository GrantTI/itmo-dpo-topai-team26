...
| № | Модуль / Элемент | Код и название компетенции | Индикатор | Уровень (Б/С/П) | Дескриптор освоения | Форма контроля | КИМ | Ресурсы |
|:-:|:---|:---|:---|:---:|:---|:---|:---|:---|
| 1 | Backend (REST API) | [Код и название] | [Номер] | Б/С/П | [Описывает команда в контексте курса так, чтобы было видно, что покрывается заданная часть компетенции – что может делать студент после освоения дисциплины] | Текущая / Рубежная / Промежуточная | ссылка | ссылка |
| 2 | Frontend | LC-5 | LC-5.1 | С | Способен применять инструменты промышленной разработки фронтенда; Умеет реализовывать интерфейсы для работы с данными | Текущая | [Модуль M2-Frontend](https://github.com/GrantTI/itmo-dpo-topai-team26/blob/main/M2-Frontend%20/README.md) | ссылка |
| 3 | Интеграция и развертывание | [Код и название] | [Номер] | Б/С/П | [Описывает команда в контексте курса так, чтобы было видно, что покрывается заданная часть компетенции – что может делать студент после освоения дисциплины] | Текущая / Рубежная / Промежуточная | ссылка | ссылка |
| 4 | Выполнение проекта | [Код и название] | [Номер] | Б/С/П | [Описывает команда в контексте курса так, чтобы было видно, что покрывается заданная часть компетенции – что может делать студент после освоения дисциплины] | Текущая / Рубежная / Промежуточная | ссылка | ссылка |
