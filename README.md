...
|:-:|:---|:---|:---|:---:|:---|:---|:---|:---|
| 1 | Backend (REST API) | [Код и название] | [Номер] | Б/С/П | [Описывает команда в контексте курса так, чтобы было видно, что покрывается заданная часть компетенции – что может делать студент после освоения дисциплины] | Текущая / Рубежная / Промежуточная | [M1-module-name](M1-module-name/README.md) | [resources](resources/README.md) |
...
- [Модуль 1](M1-module-name/README.md) — Backend (REST API);
