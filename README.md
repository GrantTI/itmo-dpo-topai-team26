...
| 3.1 | Интеграция и развёртывание (интеграция API и инференса) | PL-1. Python: способен применять язык программирования Python для решения задач в области ИИ | PL-1.1 | С | Согласовывает контракт REST API между клиентом и сервером; реализует на FastAPI обращение к внешнему или mock-сервису инференса с управлением секретами через переменные окружения и обработкой ошибок и таймаутов | Текущая | [M3-integration-deployment](M3-integration-deployment/README.md) | [resources](resources/README.md) |
| 3.2 | Интеграция и развёртывание (production-контур) | LC-5. Промышленная разработка, развёртывание, эксплуатация и мониторинг систем ИИ | LC-5.1 | С | Настраивает и кастомизирует контур развёртывания клиент-серверного ML-приложения (Docker, Docker Compose, Nginx, переменные окружения, multi-stage сборка); обеспечивает воспроизводимый запуск рабочей версии ПО и проверку работоспособности сервисов | Текущая / рубежная | [M3-integration-deployment](M3-integration-deployment/README.md) | [resources](resources/README.md) |
