...
1\. **Объектно-ориентированное программирование (ООП)**. Код компетенций: PL-2, PL-3. Уровень: Средний

---

2\. **Обработка данных на Python**. Код компетенций: PL-1. Уровень: Базовый

---

3\. **Машинное обучение**. Код компетенций\*\*: ML-3, ML-4, ML-7, MF-4, BD-1, LC-5. Уровень: Базовый

---

4\. **MLOps & DevOps**. Код компетенций: LC-4. Уровень: Средний

---

5\. **Технологии тестирования программного обеспечения.** Код компетенций: PL-3. Уровень: Средний

---

6\. **Компьютерные сети**. Код компетенций: LC-5. Уровень: Базовый.
