...
| 2 | Frontend | LC-5 | LC-5.1 | С | Способен применять инструменты промышленной разработки фронтенда
Умеет реализовывать интерфейсы для работы с данными | Текущая | ссылка | ссылка |
