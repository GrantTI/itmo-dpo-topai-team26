...
**Необходимые условия:** освоение раздела JavaScript модуля 2; проведение теста в аудитории или в электронной форме по указанию преподавателя.

**Форма контроля:** текущая (тест).

**Формат сдачи:** письменные или электронные ответы на вопросы теста.

**Максимальный балл:** 3 (шкала — в конце файла).
...
| Балл | Критерий |
|:----:|----------|
| 3 | Правильные ответы на 25–30 вопросов (83–100%) |
| 2 | Правильные ответы на 18–24 вопроса (60–82%) |
| 1 | Правильные ответы на 10–17 вопросов (33–59%) |
| 0 | Правильные ответы на 0–9 вопросов (0–32%) |
| **3** | **ИТОГО** |
