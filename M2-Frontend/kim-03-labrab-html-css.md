...
**Необходимые условия:** освоение темы HTML и CSS в объёме модуля 2; установленные редактор кода и браузер.

**Форма контроля:** текущая (защита лабораторной работы).

**Формат сдачи:** демонстрация выполненных заданий в браузере; ответы на уточняющие вопросы преподавателя по разметке и стилям. Оценивание HTML/CSS входит в суммарную шкалу лабораторных работ по HTML/CSS и JavaScript (максимум **10** баллов за обе работы; вклад настоящей работы — критерий ниже).
...
Максимум за вклад настоящей работы в суммарную оценку лабораторных работ HTML/CSS и JavaScript: **2 балла** (общая шкала двух работ — **10** баллов; см. методические указания преподавателям по модулю 2).

| Критерий | Баллы |
|---|---:|
| HTML и CSS — создана семантически корректная структура HTML-документа с заголовками, абзацами, списками, гиперссылками и изображениями; реализованы формы с текстовыми полями, чекбоксами, радиокнопками, выпадающими списками и полем загрузки файлов; все поля имеют корректные подписи и атрибуты; применены CSS-стили для оформления страницы и интерактивных состояний элементов | 0–2 |
| **ИТОГО (вклад настоящей работы)** | **2** |
