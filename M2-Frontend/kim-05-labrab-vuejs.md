...
**Необходимые условия:** освоенные HTML/CSS и JavaScript модуля 2; установленные Node.js / Vite, браузер и среда Python с FastAPI.

**Форма контроля:** текущая (защита лабораторной работы).

**Формат сдачи:** демонстрация работающего приложения в браузере; ответы на вопросы преподавателя по архитектуре и коду. Максимум — **15** баллов (критерии — в конце файла).
