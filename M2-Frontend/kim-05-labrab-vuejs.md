...
Разработка интерфейса для выбора ML модели
...
Дескриптор освоения
Интерфейс выбора модели и гиперпараметров (динамические формы, категориальные данные, флаги)

Отображение метрик и коэффициентов

Интеграция Vue.js 3 в FastAPI

Загрузка данных из файлов в зависимости от выбора модели
...
│  ┌─────────────────────────────────────────────────────┐   │
│  │  • Выбор модели (select)                            │   │
│  │  • Динамические поля для гиперпараметров            │   │
│  │  • Флаги и чекбоксы                                │   │
│  │  • Отображение метрик и коэффициентов              │   │
│  └─────────────────────────────────────────────────────┘   │
│                          │                                  │
...
│  │  • Возврат метрик и коэффициентов                 │   │
│  └─────────────────────────────────────────────────────┘   │
└─────────────────────────────────────────────────────────────┘
Ключевые концепции Vue.js 3
Концепция	Назначение
v-model	Двусторонняя привязка данных
v-for	Динамическое создание элементов
v-if / v-else	Условный рендеринг
ref / reactive	Реактивные данные
watch	Отслеживание изменений
onMounted	Выполнение кода после монтирования
Ход работы
