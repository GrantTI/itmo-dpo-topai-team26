...
**Необходимые условия:** освоение раздела Vue.js 3 модуля 2; проведение теста в аудитории или в электронной форме по указанию преподавателя.

**Форма контроля:** текущая (тест).

**Формат сдачи:** письменные или электронные ответы на вопросы теста.

**Максимальный балл:** 4 (шкала — в конце файла).
...
# Критерии оценки тестирования по Vue.js 3

| Балл | Критерий |
|:----:|----------|
| 4 | Правильные ответы на 18–20 вопросов (90–100%) |
| 3 | Правильные ответы на 14–17 вопросов (70–89%) |
| 2 | Правильные ответы на 10–13 вопросов (50–69%) |
| 1 | Правильные ответы на 5–9 вопросов (25–49%) |
| 0 | Правильные ответы на 0–4 вопроса (0–24%) |
| **4** | **ИТОГО** |
