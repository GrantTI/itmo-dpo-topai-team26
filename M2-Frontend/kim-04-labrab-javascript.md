...
## Тема: Визуализация данных в ML моделях. Javascript
...
**Необходимые условия:** выполненная лабораторная работа по HTML и CSS; установленные редактор кода, браузер и среда Python для заданий с API.

**Форма контроля:** текущая (защита лабораторной работы).

**Формат сдачи:** демонстрация результата в браузере; ответы на вопросы преподавателя по коду. Оценивание входит в суммарную шкалу лабораторных работ HTML/CSS и JavaScript (максимум **10** баллов за обе работы; критерии — в конце файла).
...
1. Как получить элемент по его ID? Приведите пример.

2. Как получить все элементы с определенным классом?

3. Какие методы можно использовать для изменения стилей элемента через JavaScript?

4. Что такое событие? Назовите 5 популярных событий.

5. Как предотвратить переход по ссылке при клике?

## Вопросы средней сложности

6. В чем разница между addEventListener и атрибутом onclick?

7. Как получить данные из текстового файла на клиентской стороне?

8. Что такое делегирование событий и зачем оно нужно?

9. Как сделать AJAX-запрос к серверу?

10. Чем отличается innerHTML от textContent?

## Вопросы продвинутого уровня

11. Что такое CORS и как его настроить для FastAPI?

12. Какие способы фильтрации данных вы знаете?

13. Как работает Canvas? Как нарисовать столбчатую диаграмму?

14. В чем разница между == и === в JavaScript?

15. Как сделать экспорт данных в CSV?

16. Что такое асинхронность в JavaScript? Приведите примеры.

17. Как обрабатывать ошибки при работе с fetch?

18. Что такое FileReader и какие методы он поддерживает?

19. Как сделать валидацию формы на JavaScript?

20. Что такое событие DOMContentLoaded и когда оно срабатывает?
...
| 2 | Загрузка данных и обучение модели — реализована загрузка файлов через интерфейс с отображением информации о данных, настроен бэкенд с классом для обучения моделей на загруженных данных |
| 2 | Динамические формы и выбор модели — список моделей загружается с сервера, реализована автоматическая генерация полей ввода в зависимости от типа параметра (флаги, выбор значений, числа) |
| 2 | Отображение результатов — реализовано отображение метрик производительности модели и параметров модели (коэффициенты или важность признаков) в понятном формате |
| 1 | Взаимодействие и обработка ошибок — настроено корректное взаимодействие между фронтендом и бэкендом через REST API, реализована обработка ошибок на бэкенде и фронтенде |
