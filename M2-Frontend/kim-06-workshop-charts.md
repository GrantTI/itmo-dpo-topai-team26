# Workshop. Визуализация графиков для ML моделей
...
**Необходимые условия:** освоенные материалы модуля 2 по Vue.js; установленные Node.js и браузер; распределение по командам по указанию преподавателя.

**Форма контроля:** текущая (защита воркшопа).

**Формат сдачи:** командная демонстрация приложения (5–10 минут), пояснение архитектурных решений и ответы на вопросы преподавателя. Максимум — **15** баллов (критерии — в конце файла).
